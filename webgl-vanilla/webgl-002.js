...
// import * as webglUtils from './webgl-util/webgl-utils.js';
...
function main() {
  ...
  let vertexShader = createShader(gl, gl.VERTEX_SHADER, vertex_shader_2d_002);
  let fragmentShader = createShader(gl, gl.FRAGMENT_SHADER, fragment_shader_2d_002);
