...
export function lerp_1_1(v1: number, v2: number, t: number) {
  return v1 * t + v2; // 기본 변형 1
}

export function lerp_1_2(v1: number, v2: number, t: number) {
  return v1 + ((v2 - v1) * t); // 기본 변형 2
}
